...
public class Contact_Us_Steps {
    ...
    public void i_enter_a_first_name() {
        driver.findElement(By.cssSelector("[name=\"first_name\"]")).sendKeys("David");
    }
    ...
    public void i_enter_an_email_address() throws InterruptedException {
        driver.findElement(By.name("email")).sendKeys("David_blog182@gmail.com");
    }
    ...
    @Then("I shoulld be presented with a successful contact us submission message")
    public void i_shoulld_be_presented_with_a_successful_contact_us_submission_message() {
        WebElement contactUs_Submission_Message = driver.findElement(By.xpath("//div[@id='contact_reply']/h1"));
        contactUs_Submission_Message.click();
        contactUs_Submission_Message.sendKeys("efef");
    }
}
